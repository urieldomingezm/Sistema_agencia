...
class RadioPlayer
{
    ...
    public function render()
    {
        ...
        echo '    <div class="radio-header">';
        echo '        <button id="closeRadioBtn" class="btn btn-sm btn-outline-danger" onclick="closeRadio()" title="Cerrar reproductor">';
    ...
    private function renderScripts2()
    {
        echo '<script>
                var radio = document.getElementById("radio");
                var playButton = document.getElementById("playButton");
