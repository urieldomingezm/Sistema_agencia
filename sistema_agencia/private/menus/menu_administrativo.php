          ...
          <div class="d-flex align-items-center me-3 gap-2">
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="userDropdown">
                ...
                <li><a class="dropdown-item py-2" href="index.php?page=configuracion"><i class="bi bi-phone me-2"></i> Modo movil</a></li>
                <li><a class="dropdown-item py-2" href="index.php?page=configuracion"><i class="bi bi-display me-2"></i> Modo escritorio</a></li>
                <li>
