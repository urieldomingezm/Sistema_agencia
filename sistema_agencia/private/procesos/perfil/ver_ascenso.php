...
if ($userCodigoTime) {
    try {
        ...
        if ($conn) {
            $sql = "SELECT a.rango_actual, a.mision_actual, a.firma_usuario, a.estado_ascenso, a.fecha_disponible_ascenso FROM ascensos a JOIN registro_usuario ru ON a.codigo_time = ru.codigo_time WHERE a.codigo_time = :codigo_time";
