<div class="min-h-screen bg-gradient-to-b from-indigo-100 via-purple-100 to-pink-100 p-4 md:p-8 flex flex-col justify-center antialiased font-sans">
  <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200 space-y-8">

    <!-- Header -->
    <header class="bg-gradient-to-r from-pink-600 to-purple-600 p-6 text-center relative rounded-b-3xl">
    ...
    <!-- Información General -->
    <section class="px-6 pt-2 space-y-6">
      <h2 class="flex items-center text-xl font-semibold text-pink-600 border-b border-pink-200 pb-2">
    ...
    <!-- Estado Requisitos -->
    <section class="bg-gray-50 px-6 py-6 border-t border-gray-200 space-y-6">
      <h2 class="flex items-center text-xl font-semibold text-gray-700 border-b border-gray-300 pb-2">
    ...
    <section class="px-6 py-6 space-y-6">
      <h2 class="flex items-center text-xl font-semibold text-gray-700 border-b border-gray-200 pb-2">
    ...
    <section class="bg-gray-50 px-6 py-6 border-t border-gray-200 space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-800">
        ...
        <div class="col-span-2">
          <p class="text-sm font-medium text-gray-700">Ya puedes solicitar tu ascenso</p>
        </div>
      </div>
    </section>
