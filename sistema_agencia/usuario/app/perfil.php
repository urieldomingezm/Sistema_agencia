  ...
  <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-blue-200">
    ...
    <section class="p-6 space-y-6">
      ...
      <div class="grid grid-cols-2 gap-x-6 gap-y-4 text-gray-800 text-base">
        <div><p class="text-sm text-blue-500">ID</p><p class="font-medium">62</p></div>
        <div><p class="text-sm text-blue-500">Usuario</p><p class="font-medium">Santidemg2</p></div>
        <div><p class="text-sm text-blue-500">Código</p><p class="font-medium">TSZU8</p></div>
        <div><p class="text-sm text-blue-500">Rango</p><p class="font-medium">Web_master</p></div>
        <div><p class="text-sm text-blue-500">Membresía</p><p class="font-medium">Sin membresía</p></div>
        <div><p class="text-sm text-blue-500">Pagos</p><p class="font-medium">-</p></div>
      </div>
    </section>
    ...
    <section class="p-6 bg-blue-50 border-t border-blue-200 space-y-4">
      ...
      <div class="grid grid-cols-2 gap-x-6 gap-y-4 text-gray-800 text-base">
        <div><p class="text-sm text-blue-500">Estado Requisitos</p><p class="font-semibold text-green-600">Completado</p></div>
        <div><p class="text-sm text-blue-500">Último Pago</p><p class="font-medium">Recibió 0c - Pago realizado</p></div>
        <div><p class="text-sm text-blue-500">Próximo Pago</p><p class="text-yellow-600 font-semibold">Pendiente de recibir pago</p></div>
      </div>
    </section>
    ...
    <section class="p-6 space-y-4">
      ...
      <div class="grid grid-cols-2 gap-x-6 gap-y-4 text-gray-800 text-base">
        <div><p class="text-sm text-blue-500">Total Acumulado</p><p class="font-medium">00:00:00</p></div>
        <div><p class="text-sm text-blue-500">Tiempo Restado</p><p class="font-medium">00:00:00</p></div>
        <div><p class="text-sm text-blue-500">Encargado</p><p class="italic text-gray-600">Sin asignar</p></div>
        <div><p class="text-sm text-blue-500">Estado</p><p class="text-red-600 font-semibold">Pausa</p></div>
      </div>
    </section>
    ...
    <section class="p-6 bg-blue-50 border-t border-blue-200 space-y-4">
      ...
      <div class="grid grid-cols-2 gap-x-6 gap-y-4 text-gray-800 text-base">
        <div><p class="text-sm text-blue-500">Misión Actual</p><p class="font-medium">Web_master</p></div>
        <div><p class="text-sm text-blue-500">Próximo Ascenso</p><p class="text-green-600 font-semibold">Disponible ahora</p></div>
    ...
    <section class="p-6 space-y-4">
      ...
      <div class="grid grid-cols-2 gap-x-6 gap-y-4 text-gray-800 text-base">
        <div><p class="text-sm text-blue-500">Estado</p><p class="text-yellow-600 font-semibold">En Espera</p></div>
        <div><p class="text-sm text-blue-500">Encargado</p><p class="font-medium">keekit08</p></div>
      </div>
    </section>
