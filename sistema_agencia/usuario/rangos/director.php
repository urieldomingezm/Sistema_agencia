                        ...
                        <div class="table-responsive">
                            <table class="table table-striped text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <h4>6 Horas</h4><img src="/usuario/rangos/image/paga/paga.png" alt="Icono" width="40">
                                        </td>
                                        <td>
                                            <h4>7 Ascensos</h4><img src="/usuario/rangos/image/paga/boni.png" alt="Icono" width="40">
                                        </td>
                                        <td>
                                            <h4>6 Horas y 7 Ascensos</h4><img src="/usuario/rangos/image/paga/paga.png" alt="Icono" width="40"><img src="/usuario/rangos/image/paga/boni.png" alt="Icono" width="40">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
