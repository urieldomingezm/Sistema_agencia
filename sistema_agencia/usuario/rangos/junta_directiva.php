            ...
            <div class="tab-pane fade" id="requisitosJTD" role="tabpanel" aria-labelledby="requisitosJTD-tab" tabindex="0">
                ...
                <div class="table-responsive">
                    <table class="table table-striped text-center">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    12 Tiempos<img src="/public/custom/custom_requisitos_rangos/paga/paga.png" alt="Icono" width="40"> 6 horas
                                </td>
                                <td>
                                    16 Tiempos<img src="/public/custom/custom_requisitos_rangos/paga/boni.png" alt="Icono" width="40"> 4 horas
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="table-responsive">
                    <table class="table table-striped text-center">
                        ...
                        <tbody>
                            <tr>
                                <td>6 Tiempos<img src="/public/custom/custom_requisitos_rangos/paga/boni.png" alt="Icono" width="40">4 horas</td>
                                <td>8 Tiempos<img src="/public/custom/custom_requisitos_rangos/paga/paga.png" alt="Icono" width="40">2 horas</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
